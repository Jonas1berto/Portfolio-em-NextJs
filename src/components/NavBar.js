  ...
  return (
    <header className="w-full px-32 py-8 dark:text-light font-medium flex items-center justify-between relative z-10 lg:px-16 md:px-12 sm:px-8">
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        ...
        <nav className="flex justify-center items-center flex-wrap border-2 border-black dark:border-light rounded-2xl px-2 py-1">
          <motion.a
      ...
      {isOpen ? (
        ...
        >
          ...
          <nav className="flex justify-center items-center flex-wrap border-2 border-light dark:border-dark rounded-2xl px-2 py-1 mt-2">
            <motion.a
              href="https://github.com/Jonas1berto"
              target={'_blank'}
              whileHover={{ y: -2 }}
